...
// @post $Return.new_balance >= 0 and $Return.new_balance < BALANCE_UPPER_BOUND
func modify_account_balance{range_check_ptr}(balance: felt, amount: felt) -> (new_balance: felt) {
